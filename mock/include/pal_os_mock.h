...
DECLARE_FAKE_VALUE_FUNC(int, pal_queue_enqueue, pal_queue_t *, void *const, size_t, int)
DECLARE_FAKE_VALUE_FUNC(int, pal_queue_dequeue, pal_queue_t *, void *const, size_t, int)
DECLARE_FAKE_VOID_FUNC(pal_queue_reset, pal_queue_t *)
DECLARE_FAKE_VALUE_FUNC(size_t, pal_queue_get_free_slots, pal_queue_t *)
DECLARE_FAKE_VALUE_FUNC(size_t, pal_queue_get_items, pal_queue_t *, int)
...
DECLARE_FAKE_VALUE_FUNC(int, pal_signal_set, pal_signal_t *, size_t, int)
...
DECLARE_FAKE_VALUE_FUNC(int, pal_timer_start, pal_timer_t *, int)
DECLARE_FAKE_VALUE_FUNC(int, pal_timer_stop, pal_timer_t *, int)
DECLARE_FAKE_VALUE_FUNC(int, pal_timer_restart, pal_timer_t *, int)
DECLARE_FAKE_VALUE_FUNC(int, pal_timer_change_period, pal_timer_t *, size_t, int)
